# PlaystationStore TypeScript SDK

The TypeScript SDK for the PlaystationStore API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| `tester(testopts?, sdkopts?)` | `PlaystationStoreSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `PlaystationStoreSDK.test(testopts?, sdkopts?)` | `PlaystationStoreSDK` | Create a test-mode client. |
...
| `client` | `client(): PlaystationStoreSDK` | Return the parent SDK client. |
...
playstation-store/
├── src/
│   ├── PlaystationStoreSDK.ts        # Main SDK class
