...
function envOverride(m) {
    if ('TRUE' === process.env.PLAYSTATION_STORE_TEST_LIVE ||
        'TRUE' === process.env.PLAYSTATION_STORE_TEST_OVERRIDE) {
    ...
    m.PLAYSTATION_STORE_TEST_EXPLAIN = process.env.PLAYSTATION_STORE_TEST_EXPLAIN || m.PLAYSTATION_STORE_TEST_EXPLAIN;
    return m;
}
