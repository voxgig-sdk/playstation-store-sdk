...
(0, node_test_1.describe)('GeoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-geo', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-geo', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PLAYSTATION_STORE_TEST_GEO_ENTID'];
...
//# sourceMappingURL=GeoDirect.test.js.map