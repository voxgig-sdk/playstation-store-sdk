...
(0, node_test_1.describe)('ImageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-image', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-image', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["age01", "container_id01", "cusa01", "language01"]))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'PLAYSTATION_STORE_TEST_IMAGE_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['PLAYSTATION_STORE_TEST_IMAGE_ENTID'];
