...
(0, node_test_1.describe)('StoreEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(store_ref01_data_dt0.id === store_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['store01', 'store02', 'store03', 'viewfinder01', 'viewfinder02', 'viewfinder03', 'container01', 'container02', 'container03', 'tumbler01', 'tumbler02', 'tumbler03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
