...
func registerSDKWords(r *eng.Registry, client *sdk.PlaystationStoreSDK) {
...
func runOp(client *sdk.PlaystationStoreSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
