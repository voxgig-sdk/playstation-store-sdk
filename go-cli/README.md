...
AQL-driven CLI and REPL for the PlaystationStore SDK. Positional arguments are
...
```sh
go build -o playstation-store-cli ./...
```
...
./playstation-store-cli list geo
./playstation-store-cli load 1 geo
./playstation-store-cli load '{id:1}' geo
