...
|---|---|---|
| `ts/` | @voxgig-sdk/playstation-store-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/playstation-store-sdk \
      --repository voxgig-sdk/playstation-store-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/playstation-store-sdk` shows it, and
`npm trust revoke @voxgig-sdk/playstation-store-sdk --id=<id>` removes it.
