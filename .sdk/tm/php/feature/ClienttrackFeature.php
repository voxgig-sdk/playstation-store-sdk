...
// PlaystationStore SDK clienttrack feature
...
class PlaystationStoreClienttrackFeature extends PlaystationStoreBaseFeature
{
    ...
    public function PostConstruct(PlaystationStoreContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PlaystationStore-SDK';
