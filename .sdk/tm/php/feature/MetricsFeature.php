...
// PlaystationStore SDK metrics feature
...
class PlaystationStoreMetricsFeature extends PlaystationStoreBaseFeature
{
    ...
    private function _record(PlaystationStoreContext $ctx, bool $ok): void
    {
