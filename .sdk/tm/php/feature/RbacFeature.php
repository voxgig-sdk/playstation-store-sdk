...
// PlaystationStore SDK rbac feature
...
class PlaystationStoreRbacFeature extends PlaystationStoreBaseFeature
{
    ...
    private function _required(PlaystationStoreContext $ctx): ?string
    {
    ...
    private function _reject(PlaystationStoreContext $ctx, string $required): void
    {
    ...
    private function _track(PlaystationStoreContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
