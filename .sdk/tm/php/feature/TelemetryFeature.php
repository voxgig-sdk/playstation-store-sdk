...
// PlaystationStore SDK telemetry feature
...
class PlaystationStoreTelemetryFeature extends PlaystationStoreBaseFeature
{
    ...
    private function _close(PlaystationStoreContext $ctx, bool $ok): void
    {
