...
// PlaystationStore SDK ratelimit feature
...
class PlaystationStoreRatelimitFeature extends PlaystationStoreBaseFeature
{
    ...
    private function _acquire(PlaystationStoreContext $ctx): void
    {
    ...
    private function _track(PlaystationStoreContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
