...
// PlaystationStore SDK proxy feature
...
class PlaystationStoreProxyFeature extends PlaystationStoreBaseFeature
{
    ...
    public function init(PlaystationStoreContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PlaystationStoreContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
