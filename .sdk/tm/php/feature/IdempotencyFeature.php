...
// PlaystationStore SDK idempotency feature
...
class PlaystationStoreIdempotencyFeature extends PlaystationStoreBaseFeature
{
    ...
    private function _mutating(PlaystationStoreContext $ctx): bool
    {
