...
// PlaystationStore SDK utility: fetcher

class PlaystationStoreFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PlaystationStoreSDK/1.0)';
    ...
    public static function call(PlaystationStoreContext $ctx, string $fullurl, array $fetchdef): array
    {
