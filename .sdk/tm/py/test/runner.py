...
class PlaystationStoreTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PlaystationStoreTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = PlaystationStoreTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = PlaystationStoreTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
