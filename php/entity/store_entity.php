...
// PlaystationStore SDK Store entity
...
class StoreEntity
{
     ...
     * Load a single Store.
     *
     * @param StoreLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StoreLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Store|array The loaded Store as an assoc-array at the
     ...
     *   the SDK boundary; throws PlaystationStoreError on failure (item-5 convention).
     */
