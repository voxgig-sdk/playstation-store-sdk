...
class GeoDirectTest extends TestCase
{
    public function test_direct_load_geo(): void
    {
        $setup = geo_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-geo", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
