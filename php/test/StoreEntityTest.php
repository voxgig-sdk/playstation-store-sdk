...
class StoreEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = PlaystationStoreSDK::test($seed, null);
...
function store_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["store01", "store02", "store03", "viewfinder01", "viewfinder02", "viewfinder03", "container01", "container02", "container03", "tumbler01", "tumbler02", "tumbler03", "age01", "country01", "language01", "search_string01"] as $k) {
