...
// PlaystationStore SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PlaystationStoreSDK::test)
...
{
    private const SDK_CLASS = 'PlaystationStoreSDK';
    ...
    private const SDK_BASE = 'playstationstore_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../playstationstore_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
