...
// PlaystationStore SDK utility: graphql
//
...
class PlaystationStoreGraphql
{
    ...
    // equivalent.
    public static function body(PlaystationStoreContext $ctx): mixed
    {
    ...
    public static function errors(PlaystationStoreContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
