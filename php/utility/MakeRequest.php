...
// PlaystationStore SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PlaystationStoreMakeRequest
{
    public static function call(PlaystationStoreContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PlaystationStoreResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PlaystationStoreResponse($fetched);
        } else {
