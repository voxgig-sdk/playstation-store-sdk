...
// PlaystationStore SDK utility type

class PlaystationStoreUtility
{
    ...
    public static function copy(PlaystationStoreUtility $src): PlaystationStoreUtility
    {
        $u = new PlaystationStoreUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
