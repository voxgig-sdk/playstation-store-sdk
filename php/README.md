...
The PHP SDK for the PlaystationStore API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Geo(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->PlaystationStore(null)->load(
    ["id" => "test01"], null
);
