...
// PlaystationStore SDK cache feature
...
class PlaystationStoreCacheFeature extends PlaystationStoreBaseFeature
{
    ...
    private function _through(PlaystationStoreContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
