...
// PlaystationStore SDK streaming feature
...
class PlaystationStoreStreamingFeature extends PlaystationStoreBaseFeature
{
    ...
    private function _iterate(PlaystationStoreResult $result): \Generator
    {
    ...
    private function _streamable(PlaystationStoreContext $ctx): bool
    {
