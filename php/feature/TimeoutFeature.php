...
// PlaystationStore SDK timeout feature
...
class PlaystationStoreTimeoutFeature extends PlaystationStoreBaseFeature
{
    ...
    private function _with_timeout(PlaystationStoreContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PlaystationStoreContext $_ctx, float $ms): void
    {
        $client = $this->client;
