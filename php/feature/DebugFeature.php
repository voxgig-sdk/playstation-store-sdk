...
// PlaystationStore SDK debug feature
...
class PlaystationStoreDebugFeature extends PlaystationStoreBaseFeature
{
    ...
    private function _finish(PlaystationStoreContext $ctx, bool $ok): void
    {
