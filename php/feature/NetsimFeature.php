...
// PlaystationStore SDK netsim feature
...
class PlaystationStoreNetsimFeature extends PlaystationStoreBaseFeature
{
    ...
    private function _simulate(PlaystationStoreContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PlaystationStoreContext $ctx, array $applied): void
    {
        $client = $this->client;
