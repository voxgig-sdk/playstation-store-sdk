...
// PlaystationStore SDK audit feature
...
class PlaystationStoreAuditFeature extends PlaystationStoreBaseFeature
{
    ...
    private function _emit(PlaystationStoreContext $ctx, string $outcome): void
    {
