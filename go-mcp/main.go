// Command PlaystationStore-mcp is an MCP server exposing the PlaystationStore
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PlaystationStore_list  — list records of an entity
//	PlaystationStore_load  — load a single record of an entity
//
