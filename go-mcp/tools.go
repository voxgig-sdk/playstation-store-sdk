...
type Args struct {
	Entity string         `json:"entity" jsonschema:"geo | image | store"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PlaystationStoreSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "playstation-store_list",
		Description: "List records from PlaystationStore. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "playstation-store_load",
		Description: "Load a single record from PlaystationStore. " +
...
func runOp(client *sdk.PlaystationStoreSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PlaystationStoreSDK, name string) (sdk.PlaystationStoreEntity, error) {
