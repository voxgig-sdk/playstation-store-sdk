...
describe("ImageEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set PLAYSTATION_STORE_TEST_IMAGE_ENTID JSON to run live")
      return
    end
...
function image_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("PLAYSTATION_STORE_TEST_IMAGE_ENTID")
