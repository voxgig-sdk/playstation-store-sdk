...
describe("GeoDirect", function()
  it("should direct-load-geo", function()
    local setup = geo_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-geo", setup.live and "live" or "unit")
...
function geo_direct_setup(mockres)
