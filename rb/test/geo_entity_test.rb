...
class GeoEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set PLAYSTATIONSTORE_TEST_GEO_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def geo_basic_setup(extra)
  ...
  entid_env_raw = ENV["PLAYSTATIONSTORE_TEST_GEO_ENTID"]
