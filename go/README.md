...
The Golang SDK for the PlaystationStore API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.
...
| `Image` | `(data map[string]any) PlaystationStoreEntity` | Create a Image entity instance. |
