...
func TestGeoEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set PLAYSTATIONSTORE_TEST_GEO_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func geoBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("PLAYSTATIONSTORE_TEST_GEO_ENTID")
	...
	idmapResolved := core.ToMapAny(env["PLAYSTATIONSTORE_TEST_GEO_ENTID"])
