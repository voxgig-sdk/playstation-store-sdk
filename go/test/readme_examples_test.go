...
const testSeed = `map[string]any{"entity": map[string]any{"geo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "image": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "store": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
