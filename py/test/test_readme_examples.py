# PlaystationStore SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PlaystationStoreSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PlaystationStoreSDK(...) and PlaystationStoreSDK.test(...) become
#      PlaystationStoreSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "playstationstore_sdk"
_SDK_CLASS = "PlaystationStoreSDK"
