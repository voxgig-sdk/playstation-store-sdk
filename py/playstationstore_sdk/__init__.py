...
from playstationstore_sdk.utility import register

# Load features
from playstationstore_sdk.feature.base_feature import PlaystationStoreBaseFeature
from playstationstore_sdk.features import _has_feature, _make_feature
...
class PlaystationStoreSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = PlaystationStoreUtility()
        self._utility = utility

        from playstationstore_sdk.config import shared_config
    ...
    def get_utility(self):
        return PlaystationStoreUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PlaystationStoreSDK: graphql: " + str(msg))
            res["graphql"] = errors
